            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* Underline accent */}
                  <span
                    className={`absolute bottom-0 left-3 right-3 h-[2px] rounded-full scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left ${isTransparent ? "bg-[#C5A861]" : "bg-[#2E6B8A]"
                      }`}
                  />
                </Link>
          ...
          >
            <nav className="container-luxury py-4 flex flex-col gap-1">
              ...
              <button
                ...
                className="mt-3 mx-2 text-center px-6 py-3 bg-[#C5A861] text-white text-sm font-bold tracking-widest uppercase rounded-md hover:bg-[#b0944f] transition-colors"
              >
                Book Now
              </button>
            </nav>
